/**
 * Sidebar summary: Tealium CDP limitations for CJA identity (flat layout — no accordions).
 */
    ...
    <div className="border-b border-gray-700 bg-gray-900/75">
      ...
      <div className="px-3 pt-3 pb-1 border-b border-gray-800/60">
        ...
        <p className="text-[10px] text-gray-500 mt-0.5 leading-snug">
          Diagram and constraints below—same scroll as the rest of the sidebar.
        </p>
      </div>
